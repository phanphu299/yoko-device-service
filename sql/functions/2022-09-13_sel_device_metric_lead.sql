drop function if EXISTS fnc_sel_device_metric_lead;
create or replace FUNCTION  fnc_sel_device_metric_lead(deviceId varchar(255), metricKey varchar(255), startDate timestamp, endDate timestamp)
returns TABLE (
