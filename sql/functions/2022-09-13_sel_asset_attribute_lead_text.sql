drop function if exists fnc_sel_asset_attribute_lead_text;
create or replace FUNCTION  fnc_sel_asset_attribute_lead_text(assetId uuid, attributeId uuid, startDate timestamp, endDate timestamp)
returns TABLE (
 value text
...
from (
 ...
 select * from (
	...
	, dms.value 
	from asset_attribute_runtime_series_text  dms 
