...
-- 	inner join metric_snapshots_float msf  on m.metric_key  = msf.metric_key  and m.device_id  = msf .device_id 
...
-- 	inner join metric_snapshots_text msf  on m.metric_key  = msf.metric_key  and m.device_id  = msf .device_id 
-- 	where e.asset_id  = assetId
-- 	) s
-- 	where s.asset_id = asset_attributes.asset_id and s.attribute_id = asset_attributes.id;
...
-- 	inner join metric_snapshots_boolean msf  on m.metric_key  = msf.metric_key  and m.device_id  = msf .device_id 
-- 	where e.asset_id  = assetId
-- 	) s
-- 	where s.asset_id = asset_attributes.asset_id and s.attribute_id = asset_attributes.id;
-- end; $$
