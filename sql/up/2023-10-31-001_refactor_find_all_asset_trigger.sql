CREATE OR REPLACE FUNCTION public.find_all_asset_trigger_by_device_id_refactor(deviceid character varying)
...
-- stored procedure body
	return query 
	  with RECURSIVE cte_assets AS  (
			...
			from v_asset_attribute_runtimes rt
    		inner join v_asset_attribute_dynamics dy on dy.asset_id = rt.trigger_asset_id and dy.attribute_id = rt.trigger_attribute_id
