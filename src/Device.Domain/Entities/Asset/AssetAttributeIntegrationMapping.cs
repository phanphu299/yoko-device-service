...
{
    public class AssetAttributeIntegrationMapping : IEntity<Guid>
    {
        ...
        public virtual AssetAttributeTemplateIntegration AssetAttributeIntegrationTemplate { set; get; }
        public AssetAttributeIntegrationMapping()
        {
            Id = Guid.NewGuid();
