...
{
    public class DynamicAssetAttributeMappingHandler : BaseAssetAttributeMappingHandler
    {
        private readonly IAssetUnitOfWork _unitOfWork;

        public DynamicAssetAttributeMappingHandler(IAssetUnitOfWork unitOfWork)
        {
        ...
        {
            return type == AttributeTypeConstants.TYPE_DYNAMIC;
        }
            ...
            bool? isKeepCreatedUtc = false)
        {
            ...
            var mappingDto = JObject.FromObject(mapping).ToObject<AssetAttributeDynamicMapping>();

            var entity = new Domain.Entity.AssetAttributeDynamicMapping()
            {
                ...
                MetricKey = templateAttribute.AssetAttributeDynamic.MetricKey,
            ...
            asset.AssetAttributeDynamicMappings.Add(entity);
            _unitOfWork.AssetAttributes.TrackMappingEntity(entity);
            return Task.FromResult(entity.Id);
        }
    }

    internal class AssetAttributeDynamicMapping
    {
