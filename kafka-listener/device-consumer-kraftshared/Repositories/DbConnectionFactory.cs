...
namespace Device.Consumer.KraftShared.Repositories
{
    public class DbConnectionFactory : IDbConnectionFactory
    {
        ...
        public NpgsqlConnection CreateConnection(string projectId)
        {
            try
            {
            ...
            {
                _logger.LogError("Ingestion_Error {data} - {ex}" , $"DbConnectionFactory create connection error: projectId={projectId}, readOnly=false", e);
                throw;
            }
        }
    }
