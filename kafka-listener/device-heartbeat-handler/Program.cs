...
using Device.Heartbeat.Handler.Processors.TrackingHeartBeat;
using Device.Heartbeat.Handler.Services;
...
namespace Device.Heartbeat.Handler
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // TrackingHeartBeat
            services.AddSingleton<TrackingHeartBeatProcessor>();
            services.AddHostedService<TrackingHeartBeatBackgroundService>();
